...
func makeWikiRequest(year, page, symbol string, cl bool, resp chan *WikiResponse) WikiRequest {
	tr := &http.Transport{DisableKeepAlives: true}
	c := &http.Client{Transport: tr}
	return WikiRequest{c, cl, resp, symbol, page, year}
}
